...
const Spaheader = () => {
  ...
  return (
    <>
      <header className={`${spaheaders ? 'bg-white py-6 rshadow-lg' : 'bg-transparent py-8'}fixed z-50 transition-all duration-500 w-full `}>
        <div className='spa_container mx-auto flex flex-col items-center gap-y-6 lg:flex-row  lg:justify-between lg:gap-y-0'>
          ...
          {/* navigation */}
          <nav className={`${spaheaders ? 'text-primary' : 'text-white'}  flex gap-x-4 uppercase items-center tracking-[3px]  font-tertiary text-[15px] lg:gap-x-8`}>
